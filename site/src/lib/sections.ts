...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    title: 'Продукты',
    description:
      'Продукты агентства «Прагматик» для застройщиков с понятным результатом и сроком: ИИ-аудит рекламных кабинетов и следующие за ним.',
    order: 2,
  },
  {
    id: 'cases',
  ...
  },
  {
    ...
    title: 'Сервисы',
    description:
      'Бесплатные интерактивные инструменты для маркетинга застройщиков: периодическая таблица УТП с конструктором рекламных сообщений.',
    order: 4,
  },
  {
    id: 'articles',
